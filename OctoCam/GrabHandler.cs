...
namespace OctoCam
{
    public class GrabHandler : HoldableObject
    {
        //ty to dev
        GameObject CameraModel = GameObject.Find("OctoCam");
        public bool
            InHand = false,
            InLeftHand = false,
            PickUp = true,
        ...
        public void Update()
        {
            float leftGripAmount = ControllerInputPoller.instance.leftControllerGripFloat;
            bool leftGrip = leftGripAmount >= 0.5f;
            float rightGripAmount = ControllerInputPoller.instance.rightControllerGripFloat;
            bool rightGrip = rightGripAmount >= 0.5f;
